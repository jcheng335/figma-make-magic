const AnimatedBackground = () => {
  return (
    <div className="fixed inset-x-0 top-0 bottom-0 overflow-hidden pointer-events-none -z-10">
      ...
      {/* Animated blobs - pushed down to avoid nav area */}
      <div className="blob blob-1 top-20 -left-32" />
      ...
      <div className="blob blob-6 top-32 left-1/3" />
      
      {/* Tight grid overlay - with top fade mask */}
      <div 
